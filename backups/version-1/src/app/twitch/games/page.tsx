...
function GameSelectionContent() {
    ...
    return (
      <div className="relative min-h-screen bg-black flex items-center justify-center">
        ...
        <div className="text-center relative z-10">
          ...
          <p className="text-2xl text-yellow-300 font-bold">جاري التحميل...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div style={{ background: 'linear-gradient(135deg, #000 0%, #1a1a1a 50%, #000 100%)' }} className="min-h-screen">
      <Header />

      <main className="container mx-auto px-4 py-12">
        {/* Welcome Section */}
        <div className="mb-16 text-center">
          <h1 className="text-6xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-500 bg-clip-text text-transparent">
            🎮 اختر اللعبة
          </h1>
          <p className="text-xl md:text-2xl text-yellow-300/70">مرحباً {userName} 👋</p>
          <p className="text-lg text-yellow-300/50 mt-2">اختر اللعبة التي تريد تشغيلها للمشاهدين</p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12">
          {GAMES.map((game) => (
            <div
              ...
              className={`bg-gradient-to-br ${game.color} p-8 rounded-2xl border-4 border-yellow-400/50 cursor-pointer hover:border-yellow-400 hover:scale-105 transition-all duration-300 hover:shadow-2xl`}
              style={{
            ...
            >
              <div className="text-center">
                ...
                <button
                  className="w-full bg-white text-black font-bold py-3 px-6 rounded-xl hover:bg-yellow-200 transition-all duration-300 text-xl"
                >
                  ▶️ ابدأ {game.name}
                </button>
              </div>
        ...
        {/* Info Section */}
        <div className="bg-gradient-to-r from-yellow-900/30 to-yellow-900/30 border-2 border-yellow-500/50 rounded-2xl p-8 mb-12">
          <h3 className="text-2xl font-bold text-yellow-300 mb-4">💡 نصائح</h3>
          <ul className="space-y-3 text-yellow-300/80">
